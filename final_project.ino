...
// BlueTooth
SoftwareSerial BT(3,2);   // TX,RX on bluetooth module, 請按照自己車上的接線寫入腳位
// L298N, 請按照自己車上的接線寫入腳位(左右不一定要跟註解寫的一樣)
#define MotorR_I1      6 //定義 I1 接腳（右）
#define MotorR_I2      7 //定義 I2 接腳（右）
#define MotorL_I3      8 //定義 I3 接腳（左）
#define MotorL_I4      9 //定義 I4 接腳（左）
#define MotorL_PWML   10 //定義 ENA (PWM調速) 接腳
...
// RFID, 請按照自己車上的接線寫入腳位
#define RST_PIN             // 讀卡機的重置腳位
#define SS_PIN              // 晶片選擇腳位
